                    ...
                    <div class="mobile-menu-wrapper">
                        <nav id="mobile-site-navigation" class="main-navigation mobile-navigation">
                            <div class="primary-menu-list main-menu-modal cover-modal" data-modal-target-string=".main-menu-modal">
                                ...
                                <div class="tablemenu">
                                    <div>
                                        <img src="./wp-content/uploads/2025/04/Frame-1-1.png" alt="">
                                    </div>
...
if (! function_exists('book_landing_page_page_content_image')) :
    ...
    function book_landing_page_page_content_image()
    {
        ...
        if (has_post_thumbnail()) (is_active_sidebar('right-sidebar') && ($sidebar_layout == 'right-sidebar')) ? the_post_thumbnail('book-landing-page-with-sidebar') : the_post_thumbnail('book-landing-page-without-sidebar');
    }
endif;
